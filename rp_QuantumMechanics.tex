...
\begin{equation}
	\begin{split}
		\langle \mathcal{O} \rangle_{\psi} := \langle \psi | \mathcal{O} | \psi \rangle = \sum_{n=1}^{\infty} \psi_{n} \mathcal{O}_{n} = \frac{ 6 }{ \pi^{2} } \sum_{n=1}^{\infty} \frac{ (-1)^{n} n }{ n^{2} } = \frac{ 6 }{ \pi^{2} } \sum_{n=1}^{\infty} \frac{ (-1)^{n} }{ n } = \frac{ 6 }{ \pi^{2} } \ln ( 2 ) \; .
	\end{split}
\end{equation}
