...
Consider the state
\begin{equation}
	\rho = \sum_{n=1}^{\infty} p_{n} | \psi_{n} \rangle \langle \psi_{n} | = \frac{ 6 }{ \pi^{2} } \sum_{n=1}^{\infty} \frac{ 1 }{ n^{2} } | \psi_{n} \rangle \langle \psi_{n} |
\end{equation}
and the observable
\begin{equation}
	\mathcal{O} = \sum_{n=1}^{\infty} \mathcal{O}_{n} | \psi_{n} \rangle \langle \psi_{n} | = \sum_{n=1}^{\infty} (-1)^{n} n | \psi_{n} \rangle \langle \psi_{n} |
\end{equation}
...
\begin{equation}
	\begin{split}
		\langle \mathcal{O} \rangle_{\rho} := \trace \left( \rho \mathcal{O} \right) &= \sum_{n=1}^{\infty} p_{n} \mathcal{O}_{n} = \frac{ 6 }{ \pi^{2} } \sum_{n=1}^{\infty} \frac{ (-1)^{n} n }{ n^{2} } = \frac{ 6 }{ \pi^{2} } \sum_{n=1}^{\infty} \frac{ (-1)^{n} }{ n } = \frac{ 6 }{ \pi^{2} } \ln ( 2 )
	\end{split}
\end{equation}
...
\begin{equation}
	\psi = \sum_{n=1}^{\infty} \psi_{n} | \psi_{n} \rangle = \frac{ \sqrt{6} }{ \pi } \sum_{n=1}^{\infty} \frac{ 1 }{ n } | \psi_{n} \rangle
\end{equation}
and then calculate the expectation value as
\begin{equation}
	\begin{split}
		\langle \mathcal{O} \rangle_{\psi} := \langle \psi | \mathcal{O} | \psi \rangle = \sum_{n=1}^{\infty} | \psi_{n} |^{2} \mathcal{O}_{n} = \frac{ 6 }{ \pi^{2} } \sum_{n=1}^{\infty} \frac{ (-1)^{n} n }{ n^{2} } = \frac{ 6 }{ \pi^{2} } \sum_{n=1}^{\infty} \frac{ (-1)^{n} }{ n } = \frac{ 6 }{ \pi^{2} } \ln ( 2 ) \; .
	\end{split}
\end{equation}
...
\begin{equation}
	\begin{split}
		\mathcal{O} | \psi \rangle &= \sum_{m=1}^{\infty} (-1)^{m} m | \psi_{m} \rangle \langle \psi_{m} | \frac{ \sqrt{6} }{ \pi } \sum_{n=1}^{\infty} \frac{ 1 }{ n } | \psi_{n} \rangle \\
		&= \frac{ \sqrt{6} }{ \pi } \sum_{m=1}^{\infty} \sum_{n=1}^{\infty} (-1)^{m} \frac{ m }{ n } | \psi_{m} \rangle \langle \psi_{m} | \psi_{n} \rangle \\
		&= \frac{ \sqrt{6} }{ \pi } \sum_{m=1}^{\infty} \sum_{n=1}^{\infty} (-1)^{m} \frac{ m }{ n } \delta_{mn} | \psi_{m} \rangle \\
		&= \frac{ \sqrt{6} }{ \pi } \sum_{n=1}^{\infty} (-1)^{n} | \psi_{n} \rangle
	\end{split}
\end{equation}
...
\begin{equation}
	|| \mathcal{O} \psi ||^{2} = \langle \psi | \mathcal{O}^{\dagger} \mathcal{O} | \psi \rangle = \langle \psi | \mathcal{O}^{2} | \psi \rangle = \langle \mathcal{O}^{2} \rangle_{\psi} < \infty
\end{equation}
