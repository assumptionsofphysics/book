...
\begin{enumerate}
	...
	\item Observables
	\begin{enumerate}
		\item not all quantities are ``Observables''
	\end{enumerate}
	\item Measurements
\end{enumerate}
...
- All infinite-dimesional (separable) Hilbert spaces are isomorphic to each other

- The state space of one particle is indistinguishable from that of a billion particles

- Hilbert spaces necesarily contain states with undefined (e.g., divergent) moments/expectation values

- The space $S^{1/2}_{1/2}$ is the space of wave functions with all moments of position and momentum defined/finite?

- The moment problem has a unique solution on $S^{1/2}_{1/2}$.

- Observables are represented by self-adjoint operators

- Not all hermitian operators are self-adjoint

- Self-adjoint operators are exactly generators of one-parameter families of unitary operators

- Self-adjoint operators are exactly those with real spectrum

- Operators with a real spectrum produce real expectation values and vice versa
