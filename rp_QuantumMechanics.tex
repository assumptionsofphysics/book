...
\newtheorem{openproblemth}[equation]{Open problem}
\newenvironment{openproblem}[2]{\begin{openproblemth}[#1]\label{label} \textnormal{[Tags: Tag1, Tag2]}}{\end{openproblemth}}
...
\begin{openproblem}{Title}{Tag1, Tag2}
...
\begin{itemize}
	...
	\item[QP-SUBS] A pure state is a density operator with only one non-zero eigenvector
