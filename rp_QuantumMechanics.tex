...
As we have already seen in classical mechanics, re-expressing the same mathematical framework in different equivalent ways brings out new understanding. This will be even more important in quantum mechanics as the postulates mix different mathematical and physical features, and it is not clear what corresponds to what.
...
\begin{equation}\label{rp-qm-qe-condEnsemblesAreDensityOperators}
	\tag{QE-DENS}
	\eqtext{A statistical ensemble for a quantum system is represented by a density operator $\rho$, a positive semi-definite, self-adjoint operator of trace one.}
\end{equation}
...
Rotations on the projective space can always be represented as unitary operations in the vector space, though, as we will see later, this is not necessary. Reflections on the projective space can be represented as anti-unitary operations.
