...
\begin{insight}
	The existence of linear combinations of pure states in quantum mechanics is equivalent to the multiple decomposition property of quantum mixtures.
\end{insight}
This links the abstract operation of quantum superposition to the more concrete physical property of statistical mixing. Since two distinct classical distributions always correspond to two distinct ensembles, it is clear that  This is a property that does not exist in classical mechanics, as .
