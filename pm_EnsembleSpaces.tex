...
We now want to find a characterization for a classical probability context: a set of ensembles that can be characterized by a family of classical probability measures. For finite discrete spaces, we want to recover the notion of a simplex. In a simplex, every element has a single decomposition in terms of extreme points. This characterization does not work in the continuous case as there are no extreme points. The trick, again, is being able to express this lack of multiple decompositions for finite mixtures.
...
TODO: this should be cleaned up and added in the main text!
...
\begin{coro}
	An ensemble that is orthogonally monodecomposable cannot be expressed as two mixtures where a component of one is orthogonal to both components of the other.
\end{coro}
