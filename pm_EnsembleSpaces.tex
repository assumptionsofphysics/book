...
\section{Flats and affine combinations}
...
It still needs to be understood what the best definition for flat is, its relationship with the topological closure, its corresponding hull and so on. The following definition represent an early attempt that needs to be revised and finalized.
