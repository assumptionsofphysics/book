...
\begin{prop}
	An ensemble is not orthogonal with itself or with its own components. Two orthogonal ensembles are separate. That is, let $\ens[a], \ens[b] \in \Ens$. If $\ens[a] \ortho \ens[b]$ then $\ens[a] \separate \ens[b]$
\end{prop}
