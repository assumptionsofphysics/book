...
\begin{mathSection}
\begin{defn}
	A \textbf{simplex} is a subset $A \subseteq \Ens$ that is the convex hull of finitely many affinely independent points. That is, there exists an affinely independent set $X \subseteq \Ens$ such $A = \hull(X)$.
\end{defn}
\end{mathSection}
