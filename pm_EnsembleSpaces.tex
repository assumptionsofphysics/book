...
\begin{mathSection}
	...
	\begin{proof}
		...
		As discussed in lesson learned \ref{pm-es-lessonEntropyContinuity}, entropy is not, in general, continuous in the standard topology on probability measures, and the same problem appears in the quantum case. Therefore, these topologies must be refined to ensure that entropy is continuous.
	\end{proof}
\end{mathSection}
