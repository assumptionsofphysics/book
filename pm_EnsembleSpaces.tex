...
\begin{remark}
	Open question: does the algebra $R_X$ contain all the nicely bounded sets?
\end{remark}
...
\begin{proof}
	...
	Let $U$ be an open set. We have $\mu(U) = \mu(U) + \mu(\emptyset) = \mu(\interior(\overline{U\cup\emptyset}))= \mu(\interior(\overline{U}))$.
\end{proof}
