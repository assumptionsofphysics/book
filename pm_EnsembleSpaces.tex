...
\end{conj}
Here we want to prove that the set of internal point is a convex set. In other words, we want to prove that the convex combination of two internal points is an internal point:

Given $e_{1}, e_{2} \in I_{\varepsilon}$
and an arbitrary convex combination $p e_{1}+\bar{p} e_{2}$. For any $a \in \varepsilon$, we have:
$$
\begin{aligned}
e_{1} & =p_{1} a+\bar{p}_{1} b_{1} \\
e_{2} & =p_{2} a+\bar{p}_{2} b_{2} \\
p e_{1}+\bar{p} e_{2} & =\left(p p_{1}+\bar{p} p_{2}\right) a+\left(p \bar{p}_{1} b_{1}+\bar{p} \bar{p}_{2} b_{2}\right) \\
& =\left(p p_{1}+\bar{p} p_{2}\right) a+\frac{\left(p \bar{p_{1}}+\bar{p} \bar{p}_{2}\right)\left(\bar{p} \bar{p}_{1} b_{1}+\bar{p} \bar{p}_{2} b_{2}\right)}{\left(p \bar{p}_{1}+\bar{p} \bar{p_{2}}\right)}
\end{aligned}
$$
As $pp_{1}+\bar{p} p_{2}+p \bar{p}_{1}+\bar{p} \bar{p}_{2}=1$
and $\frac{\left(p \bar{p}_{1} b_{1}+\bar{p} \bar{p}_{2} b_{2}\right)}{p \bar{p}_{1}+\bar{p} \bar{p}_{2}}$ is an ensemble, $p e_{1}+\bar{p} e_{2}$ is an internal point. Hence, the convex combination of the internal point is an internal point. Hence $I_{\varepsilon}$ is a convex set.
\begin{remark}
