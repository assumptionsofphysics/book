...
\begin{defn}
	An \textbf{interior point} of an ensemble space is an ensemble $\ens \in \Ens$ such that for every $\ens[a] \in \Ens$ there exists $\ens[b] \in \Ens$ and $p \in (0,1)$ such that $\ens = p \ens[a] + \bar{p} \ens[b]$. 
\end{defn}
