...
\begin{figure}[H]
	...
	\begin{tikzpicture}		
		...
		\draw[fill=lightgray, thick] ($(center)+\radius*({cos(0+\angle)},{sin(0+\angle)})$) -- ($(center)+\radius*({cos(120+\angle)},{sin(120+\angle)})$) -- ($(center)+\radius*({cos(240+\angle)},{sin(240+\angle)})$) -- cycle;
