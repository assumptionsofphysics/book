...
\begin{mathSection}
	...
	\begin{proof}
		$(\Rightarrow)$: Let $U$ be an open neighborhood of $\ens$. Since the map $(\lambda, \ens[b]) \mapsto \lambda \ens + \bar{\lambda} \ens[b]$ is continuous and sends $[0,1] \times \{\ens\}$ to $\ens \in U$, by the tube lemma (using compactness of $[0,1]$), there exists an open neighborhood $V$ of $\ens$ such that $\lambda \ens + \bar{\lambda} \ens[b] \in U$ for all $\ens[b] \in V$ and all $\lambda \in [0,1]$.
		...
		\begin{equation}
			\lambda_i \ens + \bar{\lambda}_i \ens[b]_i = \frac{p_i - p}{\bar{p}} \ens + \frac{1 - p - p_i + p}{\bar{p}} (p\ens + \bar{p}\ens[a]_i) = \frac{p_i - p + p - p p_i}{\bar{p}} \ens + \frac{1 - p_i}{\bar{p}} \bar{p} \ens[a] = p_i \ens + \bar{p}_i \ens[a]_i.
		\end{equation}
