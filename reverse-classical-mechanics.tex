...
\begin{figure}
	...
	\begin{tikzpicture}
	\end{tikzpicture}
	\caption {TODO: F1 Hamiltonian with gradient and then displacement field.}
\end{figure}
...
%TODO: make partial derivative consistent
\begin{equation}
	\begin{aligned}
...
\begin{equation}
	\begin{aligned}
		...
		&= 0 - \{G_j, p_i\} + \{G_i, p_j \} + 0 \\
		&= - \frac{\partial G_j}{\partial q^i} + \frac{\partial G_i}{\partial q^j} \\
		&= curl(G_j). \\
	\end{aligned}
\end{equation}
