...
Our understanding of Hamiltonian mechanics is now far super to that of Lagrangian mechanics: we have a good sense of how the geometry of the space work and what it represents physically. Conceptually, we already know that Lagrangian mechanics is Hamiltonian mechanics plus assumption \ref{assum_kineq}. We know want to use that insight to get a better understanding of Lagrangian mechanics. In particular, we want to understand what a Lagrangian actually represents and what the principle of least action represent.