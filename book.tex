...
\begin{axiom}\label{ax_verifiable_statements}
	A \textbf{verifiable statement} is a statement that, if true, can be shown to be so experimentally. Formally, each logical context $\logCtx$ contains a set of statements $\vstmtSet \subseteq \logCtx$ with the following properties:
	\begin{description}
		\item content...
	\end{description}
	An element of $\vstmtSet$ is called verifiable. 
\end{axiom}
\begin{justification}
